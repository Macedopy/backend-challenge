...
class GlobalExceptionHandler {
    @ExceptionHandler(MenuItemNotFoundException)
    ResponseEntity<Map<String, Object>> handleNotFound(MenuItemNotFoundException ex) {
        ResponseEntity
            .status(HttpStatus.NOT_FOUND)
            .body(buildError(HttpStatus.NOT_FOUND, ex.message))
    }

    @ExceptionHandler(MenuItemAlreadyExistsException)
    ResponseEntity<Map<String, Object>> handleConflict(MenuItemAlreadyExistsException ex) {
        ResponseEntity
            .status(HttpStatus.CONFLICT)
            .body(buildError(HttpStatus.CONFLICT, ex.message))
    }
